    ...
    <div className="space-y-8 animate-fade-up">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        {["active", "trialing"].includes(data.subscription_status) ? (
          ...
          <div className="glass-dark hero-glow animate-float relative overflow-hidden rounded-2xl text-white p-7 shadow-soft-lg" data-testid="dashboard-premium-upsell">
