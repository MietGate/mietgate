  ...
  return (
    <div className="bg-background">
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 pt-8 pb-20 lg:pt-12 lg:pb-24 grid lg:grid-cols-2 gap-14 items-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid grid-cols-2 gap-3 mt-8 max-w-md">
              <Button size="lg" asChild data-testid="hero-cta" className="group">
                <Link to="/registrieren" className="w-full">Kostenlos starten <ArrowRight className="h-4 w-4 ml-1 transition-transform group-hover:translate-x-1" /></Link>
              </Button>
        ...
        <div className="hidden lg:flex justify-center pb-4 animate-bounce-soft">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <motion.div {...fade} className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-3">In unter 2 Minuten erklärt.</p>
        </motion.div>
        <motion.div {...fade}>
      ...
      <section className="border-y border-border bg-secondary/40">
        <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {[
            ...
            <motion.div key={i} {...fade} transition={{ duration: 0.5, delay: i * 0.08 }} className="flex flex-col items-center">
            ...
            <ul className="mt-7 space-y-4">
              {oldWay.map((t, i) => (
                <motion.li key={i} {...fadeLeft} transition={{ duration: 0.4, delay: i * 0.08 }}
                  className="flex items-start gap-3 text-muted-foreground line-through decoration-destructive/30 decoration-1">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-12">
            {benefits.map((b, i) => (
              <motion.div key={i} {...fade} transition={{ duration: 0.5, delay: i * 0.08 }}
                ...
                <div className="h-11 w-11 rounded-lg bg-accent flex items-center justify-center text-primary transition-transform group-hover:scale-110"><b.icon className="h-5 w-5" /></div>
      ...
      <section id="ablauf" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="relative grid md:grid-cols-4 gap-6 mt-14">
          <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} viewport={{ once: true }} transition={{ duration: 1.1, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
            ...
            style={{ width: "calc(75% + 22px)" }} />
          {steps.map((s, i) => (
            <motion.div key={i} {...fade} transition={{ duration: 0.5, delay: i * 0.12 }} className="relative">
              <div className="h-11 w-11 rounded-full bg-brand-dark text-white font-display font-semibold flex items-center justify-center text-lg ring-4 ring-background">{s.n}</div>
      ...
      <section className="border-t border-border">
        ...
        <motion.p {...fade} className="text-muted-foreground mt-3 text-lg text-center max-w-2xl mx-auto">Vom ersten Objekt bis zum ganzen Portfolio – MietGate wächst mit.</motion.p>
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          {audiences.map((g, i) => (
            <motion.div key={i} {...fade} transition={{ duration: 0.5, delay: i * 0.08 }}
              className="rounded-2xl border border-border bg-card p-8 hover:-translate-y-1 hover:shadow-lg hover:border-primary/40 transition-all group">
        ...
        <motion.div {...fade} className="rounded-3xl bg-brand-dark text-white p-12 lg:p-16 text-center relative overflow-hidden grain">
          ...
          <div className="relative">
            ...
            <Button size="lg" className="mt-8 group" asChild>
              <Link to="/registrieren">Kostenlos starten <ArrowRight className="h-4 w-4 ml-1 transition-transform group-hover:translate-x-1" /></Link>
            </Button>
