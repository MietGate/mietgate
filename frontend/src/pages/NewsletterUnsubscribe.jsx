    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-6">
      <div className="w-full max-w-sm text-center">
        ...
        <div className="rounded-2xl border border-border bg-card p-8">
          ...
          {status === "ok" && (
            <>
              <div className="h-12 w-12 rounded-xl bg-accent flex items-center justify-center text-primary mx-auto mb-4"><MailX className="h-6 w-6" /></div>
              <h1 className="font-display text-xl font-bold">Abgemeldet</h1>
              <p className="text-muted-foreground mt-2 text-sm">Sie erhalten ab sofort keine Newsletter-E-Mails mehr von uns.</p>
            </>
          )}
          {status === "error" && (
            <>
              ...
              <p className="text-muted-foreground mt-2 text-sm">Dieser Abmeldelink ist ungültig.</p>
            </>
          )}
